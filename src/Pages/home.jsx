    ...
    <div className="flex flex-col items-center">
      <div className="grid grid-cols-1 md:grid-cols-custom-3 gap-5 justify-center p-5 md:p-10">
        <div className="p-6 backdrop-opacity-10">
          <div className="text-4xl md:text-8xl font-extrabold font-firasans text-white">
            Hello,
            <br />
          ...
          <h2 className="text-2xl md:text-5xl text-white pt-4 font-semibold whitespace-nowrap">
            <span
          ...
          <br />
          <p
            className={`text-lg md:text-2xl font-light text-white transition-opacity duration-700 antialiased ${
              fade ? "opacity-100" : "opacity-0"
            }`}
          >
            {currentSentence}
        ...
        <div className="flex justify-center items-center p-6 md:block">
          <a href="https://github.com/Zeshanxviii">
            <svg
              ...
              className="feather feather-github cursor-pointer text-white  md:float-right"
            >
      ...
      <button className="outline outline-offset-2 outline-pink-500 rounded-lg px-5 py-3 hover:bg-pink-500 hover:text-white text-pink-500 font-bold mt-5">
        Let's Connect
      </button>
    </div>
  );
